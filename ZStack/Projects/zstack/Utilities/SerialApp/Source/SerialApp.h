...
// device's needs
#define SERIALAPP_ENDPOINT           123

#define SERIALAPP_PROFID        0x0AB5
#define SERIALAPP_CENTER_DEVICEID           0x0001
#define SERIALAPP_END_DEVICEID           0x0002
#define SERIALAPP_DEVICE_VERSION     0
#define SERIALAPP_FLAGS              0

#define SERIALAPP_CENTER_OUT_MAX_CLUSTERS       3
#define SERIALAPP_CENTER_IN_MAX_CLUSTERS       2
#define SERIALAPP_END_OUT_MAX_CLUSTERS SERIALAPP_CENTER_IN_MAX_CLUSTERS  
#define SERIALAPP_END_IN_MAX_CLUSTERS  SERIALAPP_CENTER_OUT_MAX_CLUSTERS
#define SERIALAPP_CLUSTERID1         1
#define SERIALAPP_CLUSTERID2         2
#define SERIALAPP_CLUSTERID_CMD      3

#define SERIALAPP_MSG_RTRY_EVT       0x0001
#define SERIALAPP_RSP_RTRY_EVT       0x0002
#define SERIALAPP_MSG_SEND_EVT       0x0004
#define SERIALAPP_MSG_AUTOMATCH      0x0008
